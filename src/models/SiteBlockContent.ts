...
import type { PageLinkInfo } from './PageLinkInfo';
import {
    PageLinkInfoFromJSON,
    PageLinkInfoFromJSONTyped,
    PageLinkInfoToJSON,
    PageLinkInfoToJSONTyped,
} from './PageLinkInfo';
...
export function SiteBlockContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiteBlockContent {
    ...
    return {
        ...
        'link_info': json['link_info'] == null ? undefined : PageLinkInfoFromJSON(json['link_info']),
    };
}
...
export function SiteBlockContentToJSONTyped(value?: SiteBlockContent | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'link_info': PageLinkInfoToJSON(value['link_info']),
    };
}
